    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="flex gap-2">
        <input
          ...
          min={minDateStr}
          className="flex-1 px-3 py-2 rounded-lg border border-border bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50 transition-all"
        />
        {value && (
          <button
            type="button"
